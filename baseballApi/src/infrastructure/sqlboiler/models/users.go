...
type User struct {
	...
	ContactNumber string    `boil:"contact_number" json:"contact_number" toml:"contact_number" yaml:"contact_number"`
...
var UserWhere = struct {
	...
	ContactNumber whereHelperstring
	...
	ContactNumber: whereHelperstring{field: "`users`.`contact_number`"},
...
var (
	userAllColumns            = []string{"id", "name", "address", "contact_number", "created_at", "updated_at"}
	userColumnsWithoutDefault = []string{"id", "name", "address", "contact_number"}
...
func (userL) LoadLoans(ctx context.Context, e boil.ContextExecutor, singular bool, maybeUser interface{}, mods queries.Applicator) error {
	...
	query := NewQuery(
		qm.From(`loans`),
		qm.WhereIn(`loans.user_id in ?`, args...),
	)
	if mods != nil {
		mods.Apply(query)
	}
